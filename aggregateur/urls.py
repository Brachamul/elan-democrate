...
urlpatterns = patterns('',
	...
	url(r'^nouveau(?:/(?P<channel>[\x00-\x7F]+))$', views.nouveau_post, name='nouveau_post_avec_chaine'),
	...
	url(r'^(?P<year>[0-9]+)-(?P<slug>[\x00-\x7F]+)/comment/(?P<pk>[a-z0-9-]+)$', views.afficher_le_commentaire, name='commentaire'),
	url(r'^(?P<year>[0-9]+)-(?P<slug>[\x00-\x7F]+)$', views.afficher_le_post, name='post'),
